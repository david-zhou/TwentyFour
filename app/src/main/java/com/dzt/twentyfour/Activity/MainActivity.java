...
public class MainActivity extends Activity implements View.OnClickListener, View.OnDragListener, View.OnTouchListener, View.OnLongClickListener, DialogInterface.OnClickListener, CheckBox.OnCheckedChangeListener{
    ...
    int timerSeconds = 120, score = 0, secondsPerCorrect = 20;
    Timer t;
    ...
    private void openScoreActivity() {
        ...
        params.putString("mode", "survival");
    ...
    private void saveRecord() {
        ...
        int thisModeHighScore = sp.getInt("survival",0);
        if (score > thisModeHighScore) {
            SharedPreferences.Editor editor = sp.edit();
            editor.putInt("survival", score);
            editor.apply();
        }
    }
