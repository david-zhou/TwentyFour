...
public class RandomActivity extends Activity implements View.OnClickListener, View.OnDragListener, View.OnTouchListener, View.OnLongClickListener, DialogInterface.OnClickListener, CheckBox.OnCheckedChangeListener{

    TextView operationArea, resultArea, scoreCounter, targetNumber, timer, checkBoxText;;
    ...
    private void saveRecord() {
        ...
        int thisModeHighScore = sp.getInt("random",0);
        if (score > thisModeHighScore) {
            SharedPreferences.Editor editor = sp.edit();
            editor.putInt("random", score);
            editor.apply();
        }
    }
